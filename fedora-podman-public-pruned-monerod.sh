...
## A script to run a public pruned monero node with podman on Fedora, using sethforprivacy docker image https://hub.docker.com/r/sethsimmons/simple-monerod ##
...
echo -e "${GREEN}Download container image and create a public pruned monerod with Podman${NC}"
...
echo -e "${GREEN}Create systemd service unit file for monerod${NC}"
